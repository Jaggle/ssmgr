...
function selectPrice(a){window.price=a;$('li[data-price="'+a+'"]').css("border","2px solid green").siblings().css("border","2px solid #fff")}function jump(){if(!window.price){alert("请先选择价格");return false}alert("付款后大概3分钟左右生效\n如果提示付款8.01，请直接付款5元即可\n付款后可关闭付款页面");window.open("/buy-product?price="+window.price)}window.ssmgrVersion="绿灯出行 版权所有";window.cdn="";window.ssmgrConfig='{"site":"https://www.greentern.net","alipay":true,"paypal":true,"paypalMode":"live","macAccount":true,"title":"Greentern - 绿灯科学上网","themePrimary":"green","themeAccent":"pink","browserColor":"#4CAF50"}';var _hmt=_hmt||[];(function(){var b=document.createElement("script");b.src="https://hm.baidu.com/hm.js?8f601b0ce3cf3559051fbc73c6bccb9c";var a=document.getElementsByTagName("script")[0];a.parentNode.insertBefore(b,a)})();
